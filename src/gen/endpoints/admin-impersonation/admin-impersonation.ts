...
export const getStartImpersonationMutationKey = () => ["startImpersonation"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    StartImpersonationMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getStartImpersonationMutationKey();
...
export type StartImpersonationMutationVariables = { data?: StartImpersonationRequest };
...
export const getStopImpersonationMutationKey = () => ["stopImpersonation"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getStopImpersonationMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type StopImpersonationMutationVariables = { impersonationId: string };
